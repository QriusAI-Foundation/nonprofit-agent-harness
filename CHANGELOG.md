...
The release that makes two claims in the README actually true: that the harness is
usable without Google, and that it is scoped to this sector rather than generic.
